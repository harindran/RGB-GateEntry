...
#End Region
        ...
        Public Sub addField(ByVal TableName As String, ByVal ColumnName As String, ByVal ColDescription As String, ByVal FieldType As SAPbobsCOM.BoFieldTypes, ByVal Size As Integer, ByVal SubType As SAPbobsCOM.BoFldSubTypes, ByVal ValidValues As String, ByVal ValidDescriptions As String, ByVal SetValidValue As String)
            ...
            objUserFieldMD = objCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oUserFields)
            Try
                'If isColumnExist(TableName, ColumnName) = True And (TableName = "@MIGTIN" And ColumnName = "type") = False Then Exit Sub
                If Not isColumnExist(TableName, ColumnName) Then
                    ...
                    End If
                    'Else
                    '    If (TableName = "@MIGTIN" And ColumnName = "type") = True Then
                    '        Dim FieldID As String = objAddOn.objGenFunc.getSingleValue("select ""FieldID"" from CUFD where ""TableID""='" & TableName & "' and ""AliasID""='" & ColumnName & "'")

                    '        If objUserFieldMD.GetByKey(TableName, FieldID) Then
                    '        End If
        ...
        Public Sub AddUDO(ByVal strUDO As String, ByVal strUDODesc As String, ByVal nObjectType As SAPbobsCOM.BoUDOObjType, ByVal strTable As String, ByVal childTable() As String, ByVal sFind() As String,
