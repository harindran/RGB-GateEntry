Public Class clsItemDetails
    ...
    Private Sub LoadDetailsToGT(ByVal FormUID As String)
        Try
            ...
            Dim OutwardMatrix, tempmat As SAPbouiCOM.Matrix
            ...
            'End If
            objForm.Close()
            If OutwardForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then OutwardForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE
        Catch ex As Exception
        ...
        Try
            ...
            If GRPO_Yes_No = "Y" Then 'From GRPO 
                If objAddOn.HANA Then
                    ...
                    strSQL += vbCrLf + " from ""@MIGTIN"" T0 where T0.""Status""='O' and T0.""U_type""='PO'"
